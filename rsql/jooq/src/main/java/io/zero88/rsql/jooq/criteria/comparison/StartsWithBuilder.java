...
public final class StartsWithBuilder extends JooqComparisonCriteriaBuilder {

    @Override
    public @NonNull ComparisonOperatorProxy operator() {
        return ComparisonOperatorProxy.STARTS_WITH;
    }
    ...
    protected @NonNull Condition compare(@NonNull Field field, @NonNull List<String> arguments,
        ...
        return field.startsWith(argParser.parse(field, arguments.get(0)));
    }
