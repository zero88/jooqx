...
val supportDatabases = arrayOf("db2", "h2", "mssql", "mysql", "oracle", "postgresql", "sqlite")
...
pools.putAll(
    mapOf(
        ...
        "jooqx:docs" to pools["jooqx"]!!.plus(":integtest:postgresql").plus(jooqxDocs),
        "rsql:sonar" to pools["rsql"]!!,
        "rsql:docs" to pools["rsql"]!!.plus(pools["jooqx"]!!).plus(":integtest:postgresql").plus(rsqlDocs)
    )
)
