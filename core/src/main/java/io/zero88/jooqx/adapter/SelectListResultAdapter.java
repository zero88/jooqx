 ...
 * @since 1.0.0
 */
public final class SelectListResultAdapter<R, C extends SQLResultConverter<R>, T extends TableLike<? extends Record>, O>
    ...
    public static <RS, C extends SQLResultConverter<RS>, T extends TableLike<? extends Record>> SelectListResultAdapter<RS, C, T, JsonRecord<?>> jsonRecord(
    ...
    public static <RS, C extends SQLResultConverter<RS>, T extends TableLike<? extends Record>, R extends Record> SelectListResultAdapter<RS, C, T, R> create(
    ...
    public static <RS, C extends SQLResultConverter<RS>, T extends TableLike<? extends Record>> SelectListResultAdapter<RS, C, T, Record> create(
    ...
    public static <RS, C extends SQLResultConverter<RS>, T extends TableLike<? extends Record>, R> SelectListResultAdapter<RS, C, T, R> create(
        @NonNull T table, @NonNull C converter, @NonNull Class<R> outputClass) {
        return new SelectListResultAdapter<>(table, converter,
                                             (a, rs) -> a.converter().convert(rs, a.table(), outputClass));
    }

    public static <RS, C extends SQLResultConverter<RS>, T extends Table<R>, R extends Record> SelectListResultAdapter<RS, C, T, R> create(
        @NonNull T table, @NonNull C converter) {
